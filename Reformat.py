...
for index, row in (formatted_file.iterrows()):
    ...
    formatted_file._set_value(index, "Url", generateIGUrl(info.iloc[index]["code"]))
    formatted_file._set_value(index, "Original Url", generateIGUrl(info.iloc[index]["code"]))
    ...
    formatted_file._set_value(index, "Facebook Comments",0)
    formatted_file._set_value(index, "Facebook Likes",0)
    formatted_file._set_value(index, "Facebook Shares",0)
    formatted_file._set_value(index, "Twitter Followers",0)
    formatted_file._set_value(index, "Twitter Following",0)
    formatted_file._set_value(index, "Twitter Reply Count",0)
    formatted_file._set_value(index, "Twitter Retweets",0)
    formatted_file._set_value(index, "Twitter Likes",0)
    formatted_file._set_value(index, "Twitter Tweets",0)
    formatted_file._set_value(index, "Linkedin Comments",0)
    formatted_file._set_value(index, "Linkedin Engagement",0)
    formatted_file._set_value(index, "Linkedin Impressions",0)
    formatted_file._set_value(index, "Linkedin Likes",0)
    formatted_file._set_value(index, "Linkedin Shares",0)
    formatted_file._set_value(index, "Linkedin Video Views",0)
    formatted_file._set_value(index,"Full Name",getFullName(info.iloc[index]["us_username"], info.iloc[index]["us_full_name"]))
    formatted_file._set_value(index,"Weblog Title", getFullName(info.iloc[index]["us_username"], info.iloc[index]["us_full_name"]))
    ...
    formatted_file._set_value(index,"Is Syndicated", "false")
    formatted_file._set_value(index,"Item Review", "false")
    formatted_file._set_value(index,"Linkedin Sponsored", "false")
    formatted_file._set_value(index, "Linkedin Video Views", 0)
